...
/*
 * Método sort do quickSort híbrido com inserção 5%, que determina o limite para utilização do método de inserção
 * como 5% do tamanho do vetor original.
 *
...
SortingData FivePercentInsertionQuickSort::sort(int *arr, int size) {
    this->threshold = size / 20; // Determina o limite como 5% do tamanho do vetor.
