...
/*
 * Método sort do quickSort híbrido com inserção 1%, que determina o limite para utilização do método de inserção
 * como 1% do tamanho do vetor original.
 *
...
SortingData OnePercentInsertionQuickSort::sort(int *arr, int size) {
    this->threshold = size / 100; // Determina o limite como 1% do tamanho do vetor.
